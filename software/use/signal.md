...
Most [other options are subpar](avoid/README.md#private-messaging-apps). They either downgrade privacy and security compared to Signal, and/or are not usable for other reasons such as not having an iOS app and/or requiring both users to be online to communicate. There is one Signal alternative which seems promising that [I recommend](software/use#private-messaging-apps).
