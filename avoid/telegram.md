[🔗](https://github.com/randomwithnoname/security-advice/tree/main/avoid/telegram.md)
...
Telegram has no E2EE support for groups or regular direct messages, only an unnecessarily crippled form of secret chat direct messages that they hide away in a menu and discourage users from using. This hardly qualifies as an E2EE messaging app based solely on that, in the same way Facebook Messenger wasnt until they made E2EE the default.
...
A major example of how Telegram's opt-in secret chat encryption has gone seriously wrong before can be found here: [Telegram's ECDH Issues](https://words.filippo.io/dispatches/telegram-ecdh/).
