...
There are also some other services which claim to provide encrypted/secure SMS. Magic doesn't exist. Both people neeed to be using the same or a compatible app to use [end-to-end encryption.
