...
](https://github.com/randomwithnoname/security-advice/tree/main/avoid/avoid.md)
...
This resource would not exist if it weren't for [GrapheneOS](https://grapheneos.org/). They post extremely useful information [on X](https://x.com/grapheneos), and this resource is currently just archiving that information in a way that is easy to find. Please support GrapheneOS if you care about privacy/security. They make very good use of donations.
